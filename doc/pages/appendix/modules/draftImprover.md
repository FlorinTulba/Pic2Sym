...
The [prototypesCUDA](../../../../../prototypesCUDA/ReadMe.md) branch introduced implementations for the *Box* and *Stack* blur algorithms: *StackBlurCUDA*, *BoxBlurCUDA* and *BoxBlurCUDAmin* (this last one performs only the initialization of the rolling sums on the GPU).<br>
