...
The first image ([I1][]) contains many coarse-textured regions (faces, shirts, glass walls and a ceiling), which allow quite early approximations by large symbols. Any following smaller symbol will be skipped by all Matching Aspects.
