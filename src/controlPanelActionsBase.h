...
class IControlPanelActions /*abstract*/ {
  ...
  */
  ...
  virtual bool loadSettings(const std::string& from = "") noexcept = 0;
  ...
  */
  ...
  virtual void newFontFamily(const std::string& fontFile) noexcept = 0;

  virtual void newFontEncoding(int encodingIdx) noexcept = 0;

#ifdef UNIT_TESTING  // Method available only in Unit Testing mode
  virtual bool newFontEncoding(const std::string& encName) noexcept = 0;
#endif  // UNIT_TESTING defined

  virtual void newFontSize(int fontSz) noexcept = 0;
  ...
  */
  ...
  virtual ~IControlPanelActions() noexcept {}

  // Slicing prevention
  IControlPanelActions(const IControlPanelActions&) = delete;
  IControlPanelActions(IControlPanelActions&&) = delete;
  IControlPanelActions& operator=(const IControlPanelActions&) = delete;
  IControlPanelActions& operator=(IControlPanelActions&&) = delete;

 protected:
  constexpr IControlPanelActions() noexcept {}
};
