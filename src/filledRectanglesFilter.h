...
/// Detects filled symbols with a rectangular shape, even degenerate ones -
/// basic lines.
class FilledRectanglesFilter : public TSymFilter<FilledRectanglesFilter> {
 public:
  SYM_FILTER_DECLARE_IS_ENABLED(FilledRectanglesFilter);
  ...
  */
  ...
  explicit FilledRectanglesFilter(
