...
class IScoreThresholds /*abstract*/ {
 public:
  ...
  virtual ~IScoreThresholds() noexcept {}

  // Slicing prevention
  IScoreThresholds(const IScoreThresholds&) = delete;
  IScoreThresholds(IScoreThresholds&&) = delete;
  IScoreThresholds& operator=(const IScoreThresholds&) = delete;
  IScoreThresholds& operator=(IScoreThresholds&&) = delete;

 protected:
  constexpr IScoreThresholds() noexcept {}
};
