...
class ActionPermit /*abstract*/ {
 public:
  virtual ~ActionPermit() noexcept {}

  // No intention to copy / move
  ActionPermit(const ActionPermit&) = delete;
  ActionPermit(ActionPermit&&) = delete;
  ActionPermit& operator=(const ActionPermit&) = delete;
  ActionPermit& operator=(ActionPermit&&) = delete;

 protected:
  ActionPermit() noexcept {}
};
