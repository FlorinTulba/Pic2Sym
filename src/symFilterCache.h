...
class SymFilterCache {
 public:
  unsigned getSzU() const noexcept { return szU; }
  double getAreaD() const noexcept { return areaD; }
  double getBbAreaD() const noexcept { return bbAreaD; }

  void setFontSz(unsigned sz) noexcept {
    szU = sz;
    areaD = (double)szU * szU;
  }

  void setBoundingBox(unsigned height, unsigned width) noexcept {
    bbAreaD = (double)height * width;
  }
 ...
 private:
  ...
  double bbAreaD{};  ///< area of the bounding box as double
};
