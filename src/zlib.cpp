/******************************************************************************
 ...
 This file was copied from the Boost distribution, as needed by zlib
...
// Compiling the file only when the compression / decompression feature is
// desired. Specify your option in 'compressOption.h'
#if defined(USE_ZLIB_COMPRESSION) && defined(BOOST_IOSTREAMS_NO_LIB)
...
void zlib_base::do_init(const zlib_params& p,
  ...
  zlib_error::check BOOST_PREVENT_MACRO_SUBSTITUTION(
      compress ? deflateInit2(s, p.level, p.method, window_bits, p.mem_level,
                              p.strategy)
