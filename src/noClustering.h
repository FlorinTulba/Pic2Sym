...
#ifndef H_NO_CLUSTERING
#define H_NO_CLUSTERING

#include "clusterAlg.h"

/// Fallback solution when no clustering is desired
class NoClustering final : public ClusterAlg {
 public:
  /// Puts each symbol into its own cluster. Other sibling classes throw
  ...
  /// Name of 'no clustering' algorithm from varConfig.txt
