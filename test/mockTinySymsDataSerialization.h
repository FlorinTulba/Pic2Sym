...
class VTinySymsIO {
 public:
  VTinySymsIO(VTinySyms&) noexcept {}
  ...
  void serialize(Archive&, const unsigned) noexcept {}

  bool loadFrom(const std::string&) noexcept { return true; }
  bool saveTo(const std::string&) const noexcept { return true; }
};
